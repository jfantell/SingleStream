...
app.addPage("/api/login", "post", function (lien) {
...
app.addPage("/api/session", function (lien) {
    lien.end(lien.getSessionData());
});

app.addPage("/api/logout", "post", function (lien) {
    if (!lien.getSessionData("logged_in")) {
...
// Add a dynamic route
app.addPage("/post/:id", function (lien) {
